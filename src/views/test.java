...
public class test extends JFrame {
	...
	public test() {
		//windows image
		setIconImage(Toolkit.getDefaultToolkit().getImage(test.class.getResource("/img_login/icons_password-64.png")));
		//windows title
		setTitle("Login");
		...
		label.setIcon(new ImageIcon(test.class.getResource("/img_login/icons_password-64.png")));
		contentPane.add(label);

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setBounds(352, 183, 64, 71);
		lblNewLabel_1.setIcon(new ImageIcon(test.class.getResource("/img_login/icons_user2-64.png")));
		contentPane.add(lblNewLabel_1);

		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(test.class.getResource("/img_login/LOGO240_240PX.png")));
		lblNewLabel_3.setBounds(98, 183, 227, 241);
		contentPane.add(lblNewLabel_3);

		JLabel lblNewLabel = new JLabel("\r\n");
		lblNewLabel.setIcon(new ImageIcon(test.class.getResource("/img_login/wood.jpg")));
